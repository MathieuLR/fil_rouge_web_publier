...
<form id="form_modif">
					...
					<div id="titre" align="center"><h2>Liste des clients</h2>
							...
							<input type="hidden" name="IdentifiantClient" value="<?= $lien->IdentifiantClient ?>">
							<div >
				 			...
				 			<br>
				 			<div>
				 				<input class="btn btn-danger btn-modif" type="button" value="Modifier" id="boutonmodif">
				 			</div>			
